...
const Settings: React.FC = () => {
  ...
  const [emailSettings, setEmailSettings] = useState({
    ...
    smtpPassword: "",
    smtpEncryption: "tls",
    fromEmail: "noreply@eventmaster.com",
    fromName: "EventMaster",
    testEmail: "",
  });
...
This email was sent to {{customer_email}}.`,
      variables: ["customer_name", "customer_email", "company_name", "invoice_number", "invoice_date", "due_date", "amount", "service_details", "payment_instructions", "invoice_link", "billing_email"],
      enabled: true,
    },
    {
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex-1">
                      <button onClick={() => handlePhotoUpload("logo")} className="px-3 py-2 border border-gray-300 dark:border-zinc-700 rounded-lg hover:bg-gray-50 dark:hover:bg-zinc-800 transition-colors text-sm">
                        Upload Logo
                      </button>
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex-1">
                      <button onClick={() => handlePhotoUpload("favicon")} className="px-3 py-2 border border-gray-300 dark:border-zinc-700 rounded-lg hover:bg-gray-50 dark:hover:bg-zinc-800 transition-colors text-sm">
                        Upload Favicon
                      </button>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 border border-gray-200 dark:border-zinc-700 rounded-lg">
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input type="checkbox" checked={securitySettings.requireTwoFactor} onChange={(e) => setSecuritySettings((prev) => ({ ...prev, requireTwoFactor: e.target.checked }))} className="sr-only peer" />
                    <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                  </label>
                </div>
                ...
                <div className="flex items-center justify-between p-4 border border-gray-200 dark:border-zinc-700 rounded-lg">
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input type="checkbox" checked={securitySettings.enableAuditLog} onChange={(e) => setSecuritySettings((prev) => ({ ...prev, enableAuditLog: e.target.checked }))} className="sr-only peer" />
                    <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
                  </label>
                </div>
              </div>
                    ...
                    <div key={template.id} className="border border-gray-200 dark:border-zinc-700 rounded-lg p-4">
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <div className="flex items-center space-x-2">
                          <button onClick={() => handlePreviewEmail(template)} className="flex items-center space-x-1 px-3 py-1 text-sm text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-lg transition-colors">
                            <Eye className="w-4 h-4" />
                            <span>View</span>
                          </button>
                          <button onClick={() => handleEditEmail(template)} className="flex items-center space-x-1 px-3 py-1 text-sm text-gray-600 dark:text-zinc-400 hover:bg-gray-50 dark:hover:bg-zinc-800 rounded-lg transition-colors">
                            <Edit className="w-4 h-4" />
                            <span>Edit</span>
                          </button>
                          <LoadingButton onClick={() => handleSendTestEmail(template)} isLoading={isLoading(`test-email-${template.id}`)} loadingText="Sending..." variant="secondary" size="sm" className="flex items-center space-x-1">
              ...
              <div className="p-4 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-yellow-700 dark:text-yellow-300 mt-1">Database operations can affect system performance. It's recommended to perform these actions during maintenance windows.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        {selectedEmailTemplate && (
          <div className="space-y-4">
            ...
            <div className="flex justify-end space-x-3 pt-4">
              <button onClick={() => setShowEmailPreviewModal(false)} className="px-4 py-2 text-sm border border-gray-300 dark:border-zinc-700 rounded-lg hover:bg-gray-50 dark:hover:bg-zinc-800 transition-colors">
                Close
              </button>
              <LoadingButton onClick={() => handleSendTestEmail(selectedEmailTemplate)} isLoading={isLoading(`test-email-${selectedEmailTemplate.id}`)} loadingText="Sending..." variant="primary" className="flex items-center space-x-2">
                <Send className="w-4 h-4" />
      ...
      <Modal isOpen={showEmailEditModal} onClose={() => setShowEmailEditModal(false)} title="Edit Email Template" size="xl">
        {editingEmailTemplate && (
          <div className="space-y-6">
            ...
            <div className="flex justify-end space-x-3 pt-4">
              <button onClick={() => setShowEmailEditModal(false)} className="px-4 py-2 text-sm border border-gray-300 dark:border-zinc-700 rounded-lg hover:bg-gray-50 dark:hover:bg-zinc-800 transition-colors">
                Cancel
              </button>
