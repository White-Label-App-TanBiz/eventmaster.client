...
const AccountSettings: React.FC = () => {
  ...
  const [profileData, setProfileData] = useState({
    ...
    company: user?.company || 'Younivent Inc.',
              ...
              <div className="flex items-center space-x-6">
                <div className="relative">
                  <div className="w-24 h-24 rounded-full bg-blue-700 flex items-center justify-center text-white text-2xl font-bold">
                    {profileData.avatar || profileData.firstName.charAt(0) + profileData.lastName.charAt(0)}
                  </div>
              ...
              <div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      type="checkbox"
                      checked={notificationData.instantNotifications}
                      onChange={(e) => setNotificationData((prev) => ({ ...prev, instantNotifications: e.target.checked }))}
