...
.custom-button {
  ...
  border-radius: 8px;
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      />
                      <span className="text-gray-500 dark:text-zinc-400">.younivent.app</span>
                      <button
                        onClick={() => handleCopyToClipboard(`${domainData.subdomain}.younivent.app`, 'Subdomain URL')}
                      ...
                      <tbody>
                        <tr className="border-b border-gray-200 dark:border-zinc-700">
                          ...
                          <td className="py-2 px-4 text-gray-600 dark:text-zinc-400 flex items-center space-x-2">
                            <span>proxy.younivent.app</span>
                            <button onClick={() => handleCopyToClipboard('proxy.younivent.app', 'CNAME value')} className="text-gray-400 hover:text-gray-600 dark:hover:text-zinc-300">
                              <Copy className="w-4 h-4" />
                            </button>
                          </td>
                        ...
                        <tr>
                          ...
                          <td className="py-2 px-4 text-gray-600 dark:text-zinc-400">_younivent.{domainData.customDomain.split('.')[0]}</td>
                          <td className="py-2 px-4 text-gray-600 dark:text-zinc-400 flex items-center space-x-2">
            ...
            <div className="space-y-8">
              ...
              <div className="flex justify-between items-center space-x-4">
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-zinc-400">
                    {emailData.testEmailSent ? 'Test email sent successfully! Please check your inbox.' : 'Send a test email to verify your SMTP configuration is working correctly.'}
                  </p>
                </div>
                <div className="flex space-x-3">
      ...
      <div className="bg-white dark:bg-zinc-900 rounded-xl border border-gray-200 dark:border-zinc-800 p-6">
        ...
        <div
          className={`border border-gray-200 dark:border-zinc-700 rounded-lg overflow-hidden ${previewMode === 'desktop' ? 'w-full h-96' : previewMode === 'tablet' ? 'w-[768px] h-96 mx-auto' : 'w-[375px] h-96 mx-auto'}`}
        >
