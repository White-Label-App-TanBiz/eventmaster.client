...
import { ConfirmationModal } from '@/components/user-inputs/modals';
...
const Payments: React.FC = () => {
  ...
  const [manualInstructions, setManualInstructions] = useState(
    'Please send payment via bank transfer to:\n\nBank: Example Bank\nAccount Name: Younivent Inc.\nAccount Number: 123456789\nRouting Number: 987654321\nReference: Invoice #{invoice_number}\n\nPlease email payment confirmation to billing@younivent.com',
  );
      ...
      <div className="bg-white dark:bg-zinc-900 rounded-xl border border-gray-200 dark:border-zinc-800 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="text-left">
            ...
            <div
              className={`text-xs mt-1 flex items-center space-x-1 ${paymentStatistics.growth.transactions.trend === 'up' ? 'text-emerald-600 dark:text-emerald-400' : 'text-red-600 dark:text-red-400'}`}
            >
          ...
          <div className="text-left">
            ...
            <div
              className={`text-xs mt-1 flex items-center space-x-1 ${paymentStatistics.growth.successRate.trend === 'up' ? 'text-emerald-600 dark:text-emerald-400' : 'text-red-600 dark:text-red-400'}`}
            >
                      ...
                      <td className="py-4 px-4">
                        <div className="text-sm">
                          ...
                          <div className="text-xs text-gray-400 dark:text-zinc-500">
                            {paymentStatistics.totalFeesCollected > 0 ? ((data.feesCollected / paymentStatistics.totalFeesCollected) * 100).toFixed(1) : '0.0'}% of total fees
                          </div>
                        </div>
                      </td>
                    </tr>
              ...
              <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-zinc-800 rounded-lg">
                ...
                <div className="flex items-center space-x-3">
                  <LoadingButton
                    ...
                    isLoading={isLoading(`test-${selectedGateway.id}`)}
                    loadingText="Testing..."
                    variant="secondary"
                    size="sm"
                    className="flex items-center space-x-2"
              ...
              {selectedGateway.name === 'manual' && (
                <div>
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <button
                      onClick={() => handleCopyToClipboard(manualInstructions, 'Payment instructions')}
                      className="flex items-center space-x-1 text-sm text-blue-700 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300"
                    >
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        />
                        <button
                          onClick={() => handleCopyToClipboard(selectedGateway.configuration.publicKey || '', 'Public key')}
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        />
                        <button
                          onClick={() => handleCopyToClipboard(selectedGateway.configuration.secretKey || '', 'Secret key')}
                          className="p-2 text-gray-400 hover:text-gray-600 dark:hover:text-zinc-300"
                        >
                          <Copy className="w-4 h-4" />
                        </button>
                    ...
                    {selectedGateway.name === 'stripe' && (
                      <div>
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          />
                          <button
                            onClick={() => handleCopyToClipboard(selectedGateway.configuration.webhookSecret || '', 'Webhook secret')}
                            className="p-2 text-gray-400 hover:text-gray-600 dark:hover:text-zinc-300"
                          >
                            <Copy className="w-4 h-4" />
                          </button>
