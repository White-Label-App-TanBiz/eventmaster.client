...
import { mockApiLicenses } from '@/data/mockData';
                    ...
                    <div className="flex items-start justify-between">
                      ...
                      >
                        ...
                        <PopoverMenuItem
                          ...
                          label="Configure"
                          onClick={() => handleLicenseAction('configure', license)}
                          isLoading={isLoading(`configure-${license.id}`)}
                        />
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                          ...
                          >
                            ...
                            <PopoverMenuItem
                              ...
                              onClick={() => handleLicenseAction('revoke', license)}
