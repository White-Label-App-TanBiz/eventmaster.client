                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between">
                        ...
                        >
                          ...
                          <PopoverMenuItem icon={<Trash2 className="w-4 h-4" />} label="Delete Client Admin" onClick={() => handleClientAction("delete", client)} className="text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20" />
                        </Popover>
                      </div>
