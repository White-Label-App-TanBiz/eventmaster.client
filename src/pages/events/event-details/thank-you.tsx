...
const EventThankYouPage: React.FC = () => {
  ...
  }, [registrationDetails, event_id, navigate]);
  ...
  const handleShare = () => {
    if (navigator.share) {
      ...
      navigator.clipboard.writeText(window.location.origin + `/events/${event_id}`);
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-xl border border-gray-200 dark:border-zinc-800 p-6 mb-8">
          ...
          <div className="space-y-4 text-gray-700 dark:text-zinc-300">
            ...
            <p>If you have any questions or need to make changes to your registration, please contact us at support@younivent.com or call (555) 123-4567.</p>
          </div>
        </div>
