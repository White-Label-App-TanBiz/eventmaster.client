...
const EventDetailsPage: React.FC = () => {
  ...
  const [event, setEvent] = useState(mockPublicEvents.find((e) => e.id === event_id));
  ...
  useEffect(() => {
    ...
    const foundEvent = mockPublicEvents.find((e) => e.id === event_id);
    setEvent(foundEvent);
  }, [event_id]);
          ...
          <div className="p-6 md:p-8">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
              ...
              <div className="flex items-center space-x-3">
                ...
                <button
                  onClick={handleShare}
                  className="p-2 rounded-full border border-gray-200 dark:border-zinc-700 text-gray-600 dark:text-zinc-400 hover:bg-gray-50 dark:hover:bg-zinc-800 transition-colors"
                ...
                <Link
                  ...
                  className="px-6 py-2 bg-gradient-to-r from-blue-700 to-cyan-700 hover:from-blue-800 hover:to-cyan-800 text-white rounded-lg text-base font-medium transition-all shadow-lg hover:shadow-xl"
                >
                  Register Now
                </Link>
              </div>
