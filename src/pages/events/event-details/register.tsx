...
const EventRegisterPage: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      navigate(`/events/${event_id}/thank-you`, {
        state: {
          registrationDetails: {
  ...
  return (
    <PublicLayout>
      <div className="max-w-5xl mx-auto">
        <div className="mb-6">
          <Link to={`/events/${event_id}`} className="inline-flex items-center space-x-2 text-blue-700 dark:text-blue-400 hover:underline">
            <ArrowLeft className="w-4 h-4" />
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-xl border border-gray-200 dark:border-zinc-800 p-6 mb-8">
          <div className="flex items-center justify-center space-x-4">
            ...
            <div className={`flex items-center justify-center w-8 h-8 rounded-full ${currentStep >= 3 ? 'bg-blue-700 text-white' : 'bg-gray-200 dark:bg-zinc-700 text-gray-700 dark:text-zinc-300'}`}>
              3
            </div>
          </div>
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-xl border border-gray-200 dark:border-zinc-800 p-6 sticky top-6">
              ...
              <div className="space-y-4">
                ...
                <div className="text-center text-sm text-gray-500 dark:text-zinc-400 flex items-center justify-center space-x-2">
                  ...
                  <span>Secure checkout powered by Younivent</span>
                </div>
              </div>
            </div>
          </div>
