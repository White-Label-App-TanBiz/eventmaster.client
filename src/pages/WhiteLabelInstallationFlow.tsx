            ...
            return (
              <React.Fragment key={stepNumber}>
                ...
                <div className="flex flex-col items-center">
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center ${isActive ? "bg-blue-700 text-white" : isCompleted ? "bg-emerald-600 text-white" : "bg-gray-200 dark:bg-zinc-700 text-gray-700 dark:text-zinc-300"}`}>
                    {isCompleted ? <Check className="w-5 h-5" /> : stepNumber}
                  </div>
                  <span className={`text-xs mt-2 ${isActive ? "text-blue-700 dark:text-blue-400 font-medium" : isCompleted ? "text-emerald-600 dark:text-emerald-400" : "text-gray-500 dark:text-zinc-400"}`}>{getStepName(stepNumber)}</span>
                </div>

                {/* Connector Line (except after last step) */}
                {stepNumber < totalSteps && <div className={`flex-1 h-1 mx-2 ${isCompleted && isStepComplete(stepNumber + 1) ? "bg-emerald-600" : isCompleted || (isActive && stepNumber > 1) ? "bg-blue-700" : "bg-gray-200 dark:bg-zinc-700"}`} />}
              </React.Fragment>
            );
          })}
        </div>
        ...
        return (
          <div className="space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">Welcome to EventMaster White-Label Setup</h2>
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-blue-200 dark:border-blue-800 p-6">
              ...
              <p className="text-gray-600 dark:text-zinc-400 mb-4">If you need assistance with your white-label setup, our support team is here to help. We also offer professional installation services if you prefer.</p>
              <div className="flex flex-wrap gap-3">
                ...
                <button onClick={() => showInfo("Contact Support", "Opening support contact form.")} className="flex items-center space-x-2 px-4 py-2 bg-blue-700 hover:bg-blue-800 text-white rounded-lg text-sm transition-colors">
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="bg-gray-50 dark:bg-zinc-800 rounded-lg p-3">
                    ...
                    <pre className="text-xs bg-gray-100 dark:bg-zinc-900 p-2 rounded font-mono overflow-x-auto">curl -fsSL https://deb.nodesource.com/setup_{formData.nodeVersion} | sudo -E bash - && sudo apt-get install -y nodejs</pre>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="bg-gray-50 dark:bg-zinc-800 rounded-lg p-3">
                    <div className="flex items-center justify-between mb-2">
                      <p className="text-sm text-gray-600 dark:text-zinc-400">Installation command:</p>
                      <button onClick={() => handleCopyToClipboard("sudo apt-get update && sudo apt-get install -y nginx", "Nginx installation command")} className="text-blue-700 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300">
                        <Copy className="w-4 h-4" />
                      </button>
                    </div>
                ...
                <div>
                  ...
                  <div className="bg-gray-50 dark:bg-zinc-800 rounded-lg p-3">
                    <div className="flex items-center justify-between mb-2">
                      <p className="text-sm text-gray-600 dark:text-zinc-400">Installation command:</p>
                      <button onClick={() => handleCopyToClipboard("sudo apt-get update && sudo apt-get install -y git", "Git installation command")} className="text-blue-700 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300">
                        <Copy className="w-4 h-4" />
                      </button>
                    </div>
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-xl border border-gray-200 dark:border-zinc-800 p-6">
              ...
              <div className="bg-gray-50 dark:bg-zinc-800 rounded-lg p-3">
                <div className="flex items-center justify-between mb-2">
                  <p className="text-sm text-gray-600 dark:text-zinc-400">Installation command:</p>
                  <button onClick={() => handleCopyToClipboard("sudo npm install -g pm2", "PM2 installation command")} className="text-blue-700 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300">
                    <Copy className="w-4 h-4" />
                  </button>
                </div>
...
sudo -u postgres psql -c "GRANT ALL PRIVILEGES ON DATABASE ${formData.dbName} TO ${formData.dbUser};"`,
                  ...
                  <pre className="text-xs bg-gray-100 dark:bg-zinc-900 p-2 rounded font-mono overflow-x-auto">
                    {`sudo -u postgres psql -c "CREATE DATABASE ${formData.dbName || "eventmaster"};"
sudo -u postgres psql -c "CREATE USER ${formData.dbUser || "postgres"} WITH ENCRYPTED PASSWORD '${formData.dbPassword ? "********" : "your_password"}';"
sudo -u postgres psql -c "GRANT ALL PRIVILEGES ON DATABASE ${formData.dbName || "eventmaster"} TO ${formData.dbUser || "postgres"};"`}
                  </pre>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-xl border border-gray-200 dark:border-zinc-800 p-6">
              ...
              <div className="bg-gray-50 dark:bg-zinc-800 rounded-lg p-3">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <button
                    onClick={() => handleCopyToClipboard(`postgresql://${formData.dbUser}:${formData.dbPassword}@${formData.dbHost}:${formData.dbPort}/${formData.dbName}`, "Database connection string")}
                    className="text-blue-700 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300"
                  >
                    <Copy className="w-4 h-4" />
                  </button>
        ...
        return (
          <div className="space-y-6">
            <div className="mb-6">
              ...
              <p className="text-gray-600 dark:text-zinc-400">Follow these steps to deploy the EventMaster application on your server.</p>
            </div>

            {/* Download Application */}
            <div className="bg-white dark:bg-zinc-900 rounded-xl border border-gray-200 dark:border-zinc-800 p-6">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Download Application</h3>
              <p className="text-sm text-gray-600 dark:text-zinc-400 mb-4">First, download the EventMaster application package to your server:</p>
              <div className="bg-gray-50 dark:bg-zinc-800 rounded-lg p-3">
                <div className="flex items-center justify-between mb-2">
                  <p className="text-sm text-gray-600 dark:text-zinc-400">Clone the repository:</p>
                  <button
                    onClick={() => handleCopyToClipboard("git clone https://github.com/eventmaster/white-label.git /var/www/eventmaster", "Git clone command")}
                    className="text-blue-700 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300"
                  >
                    <Copy className="w-4 h-4" />
                  </button>
                </div>
                <pre className="text-xs bg-gray-100 dark:bg-zinc-900 p-2 rounded font-mono overflow-x-auto">git clone https://github.com/eventmaster/white-label.git /var/www/eventmaster</pre>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-xl border border-gray-200 dark:border-zinc-800 p-6">
              ...
              <div className="bg-gray-50 dark:bg-zinc-800 rounded-lg p-3">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <button onClick={() => handleCopyToClipboard(`cd /var/www/eventmaster && cp .env.example .env && nano .env`, "Create .env command")} className="text-blue-700 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300">
                    <Copy className="w-4 h-4" />
                  </button>
                </div>
                <pre className="text-xs bg-gray-100 dark:bg-zinc-900 p-2 rounded font-mono overflow-x-auto">cd /var/www/eventmaster && cp .env.example .env && nano .env</pre>
              </div>
              ...
              <div className="space-y-4">
                <div className="bg-gray-50 dark:bg-zinc-800 rounded-lg p-3">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <button onClick={() => handleCopyToClipboard("cd /var/www/eventmaster && npm install", "Install dependencies command")} className="text-blue-700 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300">
                      <Copy className="w-4 h-4" />
                    </button>
                  </div>
                  <pre className="text-xs bg-gray-100 dark:bg-zinc-900 p-2 rounded font-mono overflow-x-auto">cd /var/www/eventmaster && npm install</pre>
                </div>
                <div className="bg-gray-50 dark:bg-zinc-800 rounded-lg p-3">
                  <div className="flex items-center justify-between mb-2">
                    <p className="text-sm text-gray-600 dark:text-zinc-400">Run database migrations:</p>
                    <button onClick={() => handleCopyToClipboard("cd /var/www/eventmaster && npm run migrate", "Run migrations command")} className="text-blue-700 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300">
                      <Copy className="w-4 h-4" />
                    </button>
                  </div>
                  <pre className="text-xs bg-gray-100 dark:bg-zinc-900 p-2 rounded font-mono overflow-x-auto">cd /var/www/eventmaster && npm run migrate</pre>
                </div>
                <div className="bg-gray-50 dark:bg-zinc-800 rounded-lg p-3">
                  <div className="flex items-center justify-between mb-2">
                    <p className="text-sm text-gray-600 dark:text-zinc-400">Build the application:</p>
                    <button onClick={() => handleCopyToClipboard("cd /var/www/eventmaster && npm run build", "Build command")} className="text-blue-700 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300">
                      <Copy className="w-4 h-4" />
                    </button>
                  </div>
                  <pre className="text-xs bg-gray-100 dark:bg-zinc-900 p-2 rounded font-mono overflow-x-auto">cd /var/www/eventmaster && npm run build</pre>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="bg-gray-50 dark:bg-zinc-800 rounded-lg p-3">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <button
                      onClick={() => handleCopyToClipboard('cd /var/www/eventmaster && pm2 start npm --name "eventmaster" -- start', "PM2 start command")}
                      className="text-blue-700 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300"
                    >
                      <Copy className="w-4 h-4" />
                    </button>
                  </div>
                  <pre className="text-xs bg-gray-100 dark:bg-zinc-900 p-2 rounded font-mono overflow-x-auto">cd /var/www/eventmaster && pm2 start npm --name "eventmaster" -- start</pre>
                </div>
                <div className="bg-gray-50 dark:bg-zinc-800 rounded-lg p-3">
                  <div className="flex items-center justify-between mb-2">
              ...
              <div className="bg-gray-50 dark:bg-zinc-800 rounded-lg p-3">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <button
                    onClick={() =>
                      handleCopyToClipboard(
                        formData.webServer === "nginx" ? `sudo nano /etc/nginx/sites-available/${formData.customDomain || "eventmaster"}` : `sudo nano /etc/apache2/sites-available/${formData.customDomain || "eventmaster"}.conf`,
                  ...
                  <>
                    <div className="bg-gray-50 dark:bg-zinc-800 rounded-lg p-3">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <button
                          onClick={() => handleCopyToClipboard(`sudo ln -s /etc/nginx/sites-available/${formData.customDomain || "eventmaster"} /etc/nginx/sites-enabled/`, "Nginx symlink command")}
                          className="text-blue-700 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300"
                        >
                          <Copy className="w-4 h-4" />
                        </button>
                      </div>
                      <pre className="text-xs bg-gray-100 dark:bg-zinc-900 p-2 rounded font-mono overflow-x-auto">sudo ln -s /etc/nginx/sites-available/{formData.customDomain || "eventmaster"} /etc/nginx/sites-enabled/</pre>
                    </div>
                    <div className="bg-gray-50 dark:bg-zinc-800 rounded-lg p-3">
                      <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="bg-gray-50 dark:bg-zinc-800 rounded-lg p-3">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <button onClick={() => handleCopyToClipboard("sudo systemctl restart nginx", "Nginx restart command")} className="text-blue-700 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300">
                          <Copy className="w-4 h-4" />
                        </button>
                      </div>
                  ...
                  <>
                    <div className="bg-gray-50 dark:bg-zinc-800 rounded-lg p-3">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <button
                          onClick={() => handleCopyToClipboard(`sudo a2ensite ${formData.customDomain || "eventmaster"}.conf`, "Apache enable site command")}
                          className="text-blue-700 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300"
                        >
                          <Copy className="w-4 h-4" />
                        </button>
                      </div>
                      <pre className="text-xs bg-gray-100 dark:bg-zinc-900 p-2 rounded font-mono overflow-x-auto">sudo a2ensite {formData.customDomain || "eventmaster"}.conf</pre>
                    </div>
                    <div className="bg-gray-50 dark:bg-zinc-800 rounded-lg p-3">
                      <div className="flex items-center justify-between mb-2">
                        <p className="text-sm text-gray-600 dark:text-zinc-400">Enable proxy modules:</p>
                        <button onClick={() => handleCopyToClipboard("sudo a2enmod proxy proxy_http", "Apache enable modules command")} className="text-blue-700 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300">
                          <Copy className="w-4 h-4" />
                        </button>
                      </div>
                    ...
                    <div className="bg-gray-50 dark:bg-zinc-800 rounded-lg p-3">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <button onClick={() => handleCopyToClipboard("sudo systemctl restart apache2", "Apache restart command")} className="text-blue-700 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300">
                          <Copy className="w-4 h-4" />
                        </button>
                      </div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gray-50 dark:bg-zinc-800 rounded-lg p-3">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <button onClick={() => handleCopyToClipboard("sudo certbot renew --dry-run", "Certbot renewal test command")} className="text-blue-700 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300">
                      <Copy className="w-4 h-4" />
                    </button>
                  </div>
        ...
        return (
          <div className="space-y-6">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 dark:text-zinc-400 max-w-2xl mx-auto">Congratulations! You've successfully set up your white-labeled EventMaster platform. Here's a summary of your installation and next steps.</p>
            </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-zinc-400">
                      <a href={`https://${formData.customDomain || "events.yourcompany.com"}/admin`} target="_blank" rel="noopener noreferrer" className="text-blue-700 dark:text-blue-400 hover:underline">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-zinc-400">
                      <a href="mailto:support@eventmaster.com" className="text-blue-700 dark:text-blue-400 hover:underline">
        ...
        <div className="flex justify-between">
          ...
          <div className="flex space-x-3">
            {currentStep < totalSteps && (
              <button onClick={handleSkip} className="px-4 py-2 border border-gray-300 dark:border-zinc-700 rounded-lg text-gray-700 dark:text-zinc-300 hover:bg-gray-50 dark:hover:bg-zinc-800 transition-colors">
                Skip
              </button>
            )}

            {currentStep < totalSteps ? (
              <button onClick={handleNext} className="flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-blue-700 to-cyan-700 hover:from-blue-800 hover:to-cyan-800 text-white rounded-lg transition-all shadow-lg hover:shadow-xl">
                <span>Next</span>
