...
const WhiteLabelInstallationFlow: React.FC = () => {
              ...
              <React.Fragment key={stepNumber}>
                ...
                {stepNumber < totalSteps && (
                  <div className={`flex-1 h-1 mx-2 ${
                    isCompleted && isStepComplete(stepNumber + 1)
                      ? 'bg-emerald-600'
  ...
  const getStepIcon = (step: number) => {
    switch (step) {
      case 1: return <Rocket className="w-6 h-6" />;
      case 2: return <Server className="w-6 h-6" />;
      case 3: return <Settings className="w-6 h-6" />;
      case 4: return <Database className="w-6 h-6" />;
      case 5: return <Terminal className="w-6 h-6" />;
          ...
          <div className="space-y-6">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">
                Welcome to EventMaster White-Label Setup
              </h2>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-zinc-400">
                      Ubuntu 20.04 LTS or later recommended with at least 2GB RAM and 1 CPU core
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-zinc-400">
                      A domain or subdomain that you can configure DNS settings for
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-zinc-400">
                      PostgreSQL 13 or later, either installed locally or a managed service
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-zinc-400">
                      SMTP credentials for sending emails (can use services like SendGrid, Mailgun, etc.)
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-xl border border-gray-200 dark:border-zinc-800 p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-zinc-800 rounded-lg">
                  ...
                  <span className="text-xs font-medium px-2 py-1 rounded-full bg-emerald-100 dark:bg-emerald-900/20 text-emerald-800 dark:text-emerald-400">
                    Recommended
                  </span>
                </div>
                <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-zinc-800 rounded-lg">
                  ...
                  <span className="text-xs font-medium px-2 py-1 rounded-full bg-blue-100 dark:bg-blue-900/20 text-blue-800 dark:text-blue-400">
                    Required
                  </span>
                </div>
                <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-zinc-800 rounded-lg">
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-xl border border-gray-200 dark:border-zinc-800 p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-zinc-400">
                    Ensure you have SSH access to your server with sudo privileges
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-xl border border-gray-200 dark:border-zinc-800 p-6">
              ...
              <p className="text-sm text-gray-600 dark:text-zinc-400 mb-4">
                PM2 is a process manager for Node.js applications that keeps your application running in the background.
              </p>
              <div className="bg-gray-50 dark:bg-zinc-800 rounded-lg p-3">
                <div className="flex items-center justify-between mb-2">
                  <p className="text-sm text-gray-600 dark:text-zinc-400">Installation command:</p>
              ...
              <div className="space-y-3">
                <div className="bg-gray-50 dark:bg-zinc-800 rounded-lg p-3">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <button
                      onClick={() => handleCopyToClipboard('node -v', 'Node.js version command')}
                      className="text-blue-700 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300"
                    >
                      <Copy className="w-4 h-4" />
                    </button>
                ...
                <div className="bg-gray-50 dark:bg-zinc-800 rounded-lg p-3">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <button
                      onClick={() => handleCopyToClipboard('npm -v', 'npm version command')}
                      className="text-blue-700 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300"
                    >
                      <Copy className="w-4 h-4" />
                    </button>
                ...
                <div className="bg-gray-50 dark:bg-zinc-800 rounded-lg p-3">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <button
                      onClick={() => handleCopyToClipboard('pm2 -v', 'PM2 version command')}
                      className="text-blue-700 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300"
                    >
                      <Copy className="w-4 h-4" />
                    </button>
        ...
        return (
          <div className="space-y-6">
            <div className="mb-6">
              ...
              <p className="text-gray-600 dark:text-zinc-400">
                Configure the core settings for your white-labeled application.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-xl border border-gray-200 dark:border-zinc-800 p-6">
              ...
              <p className="text-sm text-gray-600 dark:text-zinc-400 mb-4">
                Configure SMTP settings to enable email functionality in your application.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-zinc-300 mb-2">
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-xl border border-gray-200 dark:border-zinc-800 p-6">
              ...
              <p className="text-sm text-gray-600 dark:text-zinc-400 mb-4">
                These environment variables will be automatically generated based on your configuration.
              </p>
              <div className="bg-gray-50 dark:bg-zinc-800 rounded-lg p-3">
                <div className="flex items-center justify-between mb-2">
                  <p className="text-sm text-gray-600 dark:text-zinc-400">Environment variables:</p>
                  <button
                    onClick={() => handleCopyToClipboard(`NODE_ENV=production
PORT=3000
...
DATABASE_URL=postgresql://${formData.dbUser}:******@${formData.dbHost}:${formData.dbPort}/${formData.dbName}`, 'Environment variables')}
                    className="text-blue-700 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300"
                  >
                    <Copy className="w-4 h-4" />
                  </button>
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-xl border border-gray-200 dark:border-zinc-800 p-6">
              ...
              <p className="text-sm text-gray-600 dark:text-zinc-400 mb-4">
                If you need to install PostgreSQL on your server, follow these steps:
              </p>
              <div className="space-y-4">
                <div className="bg-gray-50 dark:bg-zinc-800 rounded-lg p-3">
                  <div className="flex items-center justify-between mb-2">
                ...
                <div className="bg-gray-50 dark:bg-zinc-800 rounded-lg p-3">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <button
                      onClick={() => handleCopyToClipboard(`sudo -u postgres psql -c "CREATE DATABASE ${formData.dbName};"
sudo -u postgres psql -c "CREATE USER ${formData.dbUser} WITH ENCRYPTED PASSWORD '${formData.dbPassword}';"
sudo -u postgres psql -c "GRANT ALL PRIVILEGES ON DATABASE ${formData.dbName} TO ${formData.dbUser};"`, 'Database creation commands')}
                      className="text-blue-700 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300"
                    >
                      <Copy className="w-4 h-4" />
                    </button>
...
sudo -u postgres psql -c "GRANT ALL PRIVILEGES ON DATABASE ${formData.dbName || 'eventmaster'} TO ${formData.dbUser || 'postgres'};"`}
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-xl border border-gray-200 dark:border-zinc-800 p-6">
              ...
              <p className="text-sm text-gray-600 dark:text-zinc-400 mb-4">
                Your application will use this connection string to connect to the database:
              </p>
              <div className="bg-gray-50 dark:bg-zinc-800 rounded-lg p-3">
                <div className="flex items-center justify-between mb-2">
        ...
        return (
          <div className="space-y-6">
            <div className="mb-6">
              ...
              <p className="text-gray-600 dark:text-zinc-400">
                Follow these steps to deploy the EventMaster application on your server.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-xl border border-gray-200 dark:border-zinc-800 p-6">
              ...
              <p className="text-sm text-gray-600 dark:text-zinc-400 mb-4">
                First, download the EventMaster application package to your server:
              </p>
              <div className="bg-gray-50 dark:bg-zinc-800 rounded-lg p-3">
                <div className="flex items-center justify-between mb-2">
                ...
                <pre className="text-xs bg-gray-100 dark:bg-zinc-900 p-2 rounded font-mono overflow-x-auto">
                  git clone https://github.com/eventmaster/white-label.git /var/www/eventmaster
                </pre>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-xl border border-gray-200 dark:border-zinc-800 p-6">
              ...
              <div className="bg-gray-50 dark:bg-zinc-800 rounded-lg p-3">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <button
                    onClick={() => handleCopyToClipboard(`cd /var/www/eventmaster && cp .env.example .env && nano .env`, 'Create .env command')}
                    className="text-blue-700 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300"
                  >
                    <Copy className="w-4 h-4" />
                  </button>
                ...
                <pre className="text-xs bg-gray-100 dark:bg-zinc-900 p-2 rounded font-mono overflow-x-auto">
                  cd /var/www/eventmaster && cp .env.example .env && nano .env
                </pre>
              </div>
              <p className="text-sm text-gray-600 dark:text-zinc-400 mt-4 mb-2">
...
SMTP_ENCRYPTION=${formData.smtpEncryption}
DATABASE_URL=postgresql://${formData.dbUser}:${formData.dbPassword}@${formData.dbHost}:${formData.dbPort}/${formData.dbName}`, 'Environment variables')}
                    className="text-blue-700 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300"
                  >
                    <Copy className="w-4 h-4" />
                  </button>
...
DATABASE_URL=postgresql://${formData.dbUser || 'postgres'}:${formData.dbPassword ? '********' : 'your_password'}@${formData.dbHost}:${formData.dbPort}/${formData.dbName}`}
              ...
              <div className="space-y-4">
                <div className="bg-gray-50 dark:bg-zinc-800 rounded-lg p-3">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <button
                      onClick={() => handleCopyToClipboard('cd /var/www/eventmaster && npm install', 'Install dependencies command')}
                      className="text-blue-700 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300"
                    >
                      <Copy className="w-4 h-4" />
                    </button>
                  ...
                  <pre className="text-xs bg-gray-100 dark:bg-zinc-900 p-2 rounded font-mono overflow-x-auto">
                    cd /var/www/eventmaster && npm install
                  </pre>
                </div>
                <div className="bg-gray-50 dark:bg-zinc-800 rounded-lg p-3">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <button
                      onClick={() => handleCopyToClipboard('cd /var/www/eventmaster && npm run migrate', 'Run migrations command')}
                      className="text-blue-700 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300"
                    >
                      <Copy className="w-4 h-4" />
                    </button>
                  ...
                  <pre className="text-xs bg-gray-100 dark:bg-zinc-900 p-2 rounded font-mono overflow-x-auto">
                    cd /var/www/eventmaster && npm run migrate
                  </pre>
                </div>
                <div className="bg-gray-50 dark:bg-zinc-800 rounded-lg p-3">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <button
                      onClick={() => handleCopyToClipboard('cd /var/www/eventmaster && npm run build', 'Build command')}
                      className="text-blue-700 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300"
                    >
                      <Copy className="w-4 h-4" />
                    </button>
                  ...
                  <pre className="text-xs bg-gray-100 dark:bg-zinc-900 p-2 rounded font-mono overflow-x-auto">
                    cd /var/www/eventmaster && npm run build
                  </pre>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-xl border border-gray-200 dark:border-zinc-800 p-6">
              ...
              <p className="text-sm text-gray-600 dark:text-zinc-400 mb-4">
                Use PM2 to start and manage your application:
              </p>
              <div className="space-y-4">
                <div className="bg-gray-50 dark:bg-zinc-800 rounded-lg p-3">
                  <div className="flex items-center justify-between mb-2">
                  ...
                  <pre className="text-xs bg-gray-100 dark:bg-zinc-900 p-2 rounded font-mono overflow-x-auto">
                    cd /var/www/eventmaster && pm2 start npm --name "eventmaster" -- start
                  </pre>
                </div>
                <div className="bg-gray-50 dark:bg-zinc-800 rounded-lg p-3">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <button
                      onClick={() => handleCopyToClipboard('pm2 save', 'PM2 save command')}
                      className="text-blue-700 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300"
                    >
                      <Copy className="w-4 h-4" />
                    </button>
                ...
                <div className="bg-gray-50 dark:bg-zinc-800 rounded-lg p-3">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <button
                      onClick={() => handleCopyToClipboard('pm2 startup', 'PM2 startup command')}
                      className="text-blue-700 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300"
                    >
                      <Copy className="w-4 h-4" />
                    </button>
        ...
        return (
          <div className="space-y-6">
            <div className="mb-6">
              ...
              <p className="text-gray-600 dark:text-zinc-400">
                Configure your domain's DNS settings and set up SSL certificates for secure HTTPS access.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-xl border border-gray-200 dark:border-zinc-800 p-6">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">
                {formData.webServer === 'nginx' ? 'Nginx' : 'Apache'} Configuration
              </h3>
              <p className="text-sm text-gray-600 dark:text-zinc-400 mb-4">
                ...
                <div className="flex items-center justify-between mb-2">
                  ...
                  <button
                    onClick={() => handleCopyToClipboard(
                      formData.webServer === 'nginx' 
                        ? `sudo nano /etc/nginx/sites-available/${formData.customDomain || 'eventmaster'}` 
                        : `sudo nano /etc/apache2/sites-available/${formData.customDomain || 'eventmaster'}.conf`,
    ...
    ProxyPassReverse / http://localhost:3000/
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-xl border border-gray-200 dark:border-zinc-800 p-6">
              ...
              <p className="text-sm text-gray-600 dark:text-zinc-400 mb-4">
                Enable the site configuration and restart the web server:
              </p>
              <div className="space-y-4">
                {formData.webServer === 'nginx' ? (
                  <>
                    <div className="bg-gray-50 dark:bg-zinc-800 rounded-lg p-3">
                      ...
                      <pre className="text-xs bg-gray-100 dark:bg-zinc-900 p-2 rounded font-mono overflow-x-auto">
                        sudo ln -s /etc/nginx/sites-available/{formData.customDomain || 'eventmaster'} /etc/nginx/sites-enabled/
                      </pre>
                    </div>
                    <div className="bg-gray-50 dark:bg-zinc-800 rounded-lg p-3">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <button
                          onClick={() => handleCopyToClipboard('sudo nginx -t', 'Nginx test command')}
                          className="text-blue-700 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300"
                        >
                          <Copy className="w-4 h-4" />
                        </button>
                  ...
                  <>
                    <div className="bg-gray-50 dark:bg-zinc-800 rounded-lg p-3">
                      ...
                      <pre className="text-xs bg-gray-100 dark:bg-zinc-900 p-2 rounded font-mono overflow-x-auto">
                        sudo a2ensite {formData.customDomain || 'eventmaster'}.conf
                      </pre>
                    </div>
                    <div className="bg-gray-50 dark:bg-zinc-800 rounded-lg p-3">
                      <div className="flex items-center justify-between mb-2">
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-xl border border-gray-200 dark:border-zinc-800 p-6">
                  ...
                  <tbody>
                    <tr className="border-b border-gray-200 dark:border-zinc-700">
                      ...
                      <td className="py-2 px-4 text-gray-600 dark:text-zinc-400">
                        {formData.customDomain ? formData.customDomain.split('.')[0] : '@'}
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="py-2 px-4 text-gray-600 dark:text-zinc-400">
                        {formData.customDomain || 'events.yourcompany.com'}
                      </td>
                      <td className="py-2 px-4 text-gray-600 dark:text-zinc-400">3600</td>
                    </tr>
                  </tbody>
              ...
              <p className="text-sm text-gray-600 dark:text-zinc-400 mt-4">
                Replace "YOUR_SERVER_IP" with your actual server IP address. DNS changes may take up to 24-48 hours to propagate.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-xl border border-gray-200 dark:border-zinc-800 p-6">
              ...
              <p className="text-sm text-gray-600 dark:text-zinc-400 mb-4">
                Set up SSL certificates using Let's Encrypt for secure HTTPS access:
              </p>
              <div className="space-y-4">
                <div className="bg-gray-50 dark:bg-zinc-800 rounded-lg p-3">
                  <div className="flex items-center justify-between mb-2">
        ...
        return (
          <div className="space-y-6">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 dark:text-zinc-400 max-w-2xl mx-auto">
                Congratulations! You've successfully set up your white-labeled EventMaster platform. Here's a summary of your installation and next steps.
              </p>
            </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-zinc-400">
                      <a 
                        href={`https://${formData.customDomain || 'events.yourcompany.com'}`} 
                        target="_blank" 
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-zinc-400">
                      Email: {formData.adminEmail || 'admin@yourcompany.com'}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-zinc-400">
                      Access your admin dashboard using the credentials you configured during setup.
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-zinc-400">
                      Update your logo, colors, and other branding elements in the White-Label settings.
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-zinc-400">
                      Configure payment gateways to start accepting payments for events.
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-zinc-400">
                      Start creating events and inviting attendees to your platform.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="flex space-x-3">
            ...
            {currentStep < totalSteps ? (
              ...
              <LoadingButton
                ...
                isLoading={isLoading('finish-setup')}
