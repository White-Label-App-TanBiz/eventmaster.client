      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-500 dark:text-zinc-500">
            Thank you for choosing EventMaster. You're all set to start creating amazing events!
          </p>
        </div>
          ...
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-600 dark:text-zinc-400 mb-4">
                Our support team is here to help you make the most of EventMaster. We've also sent you a welcome email with helpful resources.
              </p>
