  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    await withLoading('checkout', async () => {
      ...
      showSuccess(
        ...
        `Welcome to ${plan.name}! Your account has been created and you can start using EventMaster immediately.`
      );
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-center space-x-8">
            <div className="flex items-center space-x-2">
              <div className="w-8 h-8 bg-blue-700 text-white rounded-full flex items-center justify-center text-sm font-semibold">
                1
              </div>
            ...
            <div className="w-12 h-px bg-gray-300 dark:bg-zinc-700"></div>
            <div className="flex items-center space-x-2">
              <div className="w-8 h-8 bg-gray-300 dark:bg-zinc-700 text-gray-600 dark:text-zinc-400 rounded-full flex items-center justify-center text-sm font-semibold">
                3
              </div>
          ...
          <div className="space-y-8">
            <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="space-y-4">
                  <label className="flex items-start space-x-3 cursor-pointer">
                    ...
                    <span className="text-sm text-gray-700 dark:text-zinc-300">
                      I agree to the <a href="#" className="text-blue-700 dark:text-blue-400 hover:underline">Terms of Service</a> and <a href="#" className="text-blue-700 dark:text-blue-400 hover:underline">Privacy Policy</a> *
                    </span>
                  </label>
              ...
              >
                ...
                <span>
                  {plan.price === 0 ? 'Start Free Plan' : `Subscribe for ${displayPrice}${billingCycle === 'yearly' ? '/year' : '/month'}`}
                </span>
              </LoadingButton>
            </form>
          </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <label className="flex items-center justify-between p-3 border border-gray-200 dark:border-zinc-700 rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-zinc-800">
                        ...
                        <div className="text-right">
                          <span className="text-sm font-semibold text-gray-900 dark:text-white">
                            {formatCurrency(plan.price * 12 * 0.8)}/year
                          </span>
                          <div className="text-xs text-gray-500 dark:text-zinc-400 line-through">
              ...
              <div className="border-t border-gray-200 dark:border-zinc-800 pt-4 space-y-3">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium text-gray-900 dark:text-white">
                    {plan.price === 0 ? 'Free' : formatCurrency(billingCycle === 'yearly' ? plan.price * 12 : plan.price)}
                  </span>
                </div>
                ...
                <div className="flex justify-between text-lg font-bold text-gray-900 dark:text-white border-t border-gray-200 dark:border-zinc-800 pt-3">
                  <span>Total</span>
                  <span>{displayPrice}{plan.price > 0 && (billingCycle === 'yearly' ? '/year' : '/month')}</span>
                </div>
              </div>
