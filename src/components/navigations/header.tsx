...
import { useTheme, useAuth } from '@/contexts/hooks';

import { LanguageSwitcher } from '../user-inputs/inputs';
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          <button
            ...
            className="lg:hidden p-2 text-gray-600 dark:text-zinc-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-zinc-800 rounded-lg transition-colors"
          >
