...
import { CheckCircle, Calendar, Clock, MapPin, Download, Share2, ArrowRight, ArrowLeft } from "lucide-react";
  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="text-center mb-12">
        ...
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Registration Successful!</h1>
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-zinc-400">
                  {registrationDetails.ticketType} x {registrationDetails.quantity}
                </p>
              </div>

              <div>
                <p className="font-medium text-gray-900 dark:text-white">Order Total</p>
                <p className="text-gray-600 dark:text-zinc-400">{registrationDetails.total === 0 ? "Free" : `$${registrationDetails.total}`}</p>
              </div>
            </div>
          </div>

          <div className="flex flex-wrap gap-3 justify-center">
            <button onClick={handleDownloadTicket} className="flex items-center space-x-2 px-4 py-2 bg-blue-700 hover:bg-blue-800 text-white rounded-lg transition-colors">
              <Download className="w-4 h-4" />
              <span>Download Ticket</span>
            </button>

            <button onClick={handleAddToCalendar} className="flex items-center space-x-2 px-4 py-2 border border-blue-700 text-blue-700 dark:border-blue-400 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-lg transition-colors">
              <Calendar className="w-4 h-4" />
              <span>Add to Calendar</span>
            </button>

            <button onClick={handleShare} className="flex items-center space-x-2 px-4 py-2 border border-gray-300 dark:border-zinc-700 text-gray-700 dark:text-zinc-300 hover:bg-gray-50 dark:hover:bg-zinc-800 rounded-lg transition-colors">
      ...
      <div className="bg-white dark:bg-zinc-900 rounded-xl border border-gray-200 dark:border-zinc-800 p-6 mb-8">
        ...
        <div className="space-y-4 text-gray-700 dark:text-zinc-300">
          ...
          {event.type === "virtual" && <p>You'll receive an email with the link to join the virtual event 24 hours before it starts. Make sure to check your spam folder if you don't see it.</p>}
      ...
      <div className="bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 rounded-xl border border-blue-200 dark:border-blue-800 p-6 mb-8">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start space-x-3">
            <div className="flex-shrink-0 w-6 h-6 rounded-full bg-blue-700 text-white flex items-center justify-center text-sm font-bold">2</div>
            <div>
          ...
          <div className="flex items-start space-x-3">
            <div className="flex-shrink-0 w-6 h-6 rounded-full bg-blue-700 text-white flex items-center justify-center text-sm font-bold">3</div>
            <div>
      ...
      <div className="flex flex-wrap justify-center gap-4">
        <Link to={`/events/${eventId}`} className="flex items-center space-x-2 px-6 py-3 border border-gray-300 dark:border-zinc-700 text-gray-700 dark:text-zinc-300 hover:bg-gray-50 dark:hover:bg-zinc-800 rounded-lg transition-colors">
          <ArrowLeft className="w-4 h-4" />
          <span>Back to Event</span>
        </Link>

        <Link to="/events" className="flex items-center space-x-2 px-6 py-3 bg-gradient-to-r from-blue-700 to-cyan-700 hover:from-blue-800 hover:to-cyan-800 text-white rounded-lg transition-all shadow-lg hover:shadow-xl">
