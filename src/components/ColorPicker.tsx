    ...
    <div className={`relative ${className}`}>
      ...
      >
        <div className="flex items-center space-x-3">
          <div 
            className="w-6 h-6 rounded border border-gray-300 dark:border-zinc-600"
      ...
      {isOpen && (
        <div
          ref={popoverRef}
          className="absolute left-0 top-full mt-2 w-80 bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-lg shadow-lg py-4 z-50 animate-fade-in"
        >
          {!showCustomPicker ? (
            <>
              {/* Predefined Colors */}
            ...
            <>
              ...
              <div className="px-4">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-3">
                    <div 
                      className="w-12 h-12 rounded-lg border border-gray-300 dark:border-zinc-600"
                    ...
                    <div className="flex-1">
                      <input
                        ...
                        className="w-full h-10 border border-gray-300 dark:border-zinc-700 rounded cursor-pointer"
                      />
                    </div>
                  </div>
                  ...
                  <div className="flex space-x-2">
                    <button
                      onClick={() => setShowCustomPicker(false)}
                      className="flex-1 px-3 py-2 border border-gray-300 dark:border-zinc-700 rounded-lg text-sm hover:bg-gray-50 dark:hover:bg-zinc-800 transition-colors"
                    >
                      Cancel
                    </button>
                    <button
                      onClick={handleCustomColorApply}
                      className="flex-1 px-3 py-2 bg-blue-700 hover:bg-blue-800 text-white rounded-lg text-sm transition-colors"
                    >
                      Apply
                    </button>
                  </div>
